...
import { DISCORD_RULES_CHANNEL_ID, DISCORD_NEWCOMERS_CHANNEL_ID } from '../configuration.js'
...
const guildMemberAdd: DiscordEvent<Events.GuildMemberAdd> = {
  ...
  execute: async (member) => {
    ...
    const channel = discordClient.channels.cache.get(DISCORD_NEWCOMERS_CHANNEL_ID)
