...
export const NITRADO_SERVER_ADMIN_PASSWORD = process.env.NITRADO_SERVER_ADMIN_PASSWORD ?? 'password'
export const NITRADO_SERVER_IP = process.env.NITRADO_SERVER_IP ?? '127.127.127.127'
export const NITRADO_SERVER_RCON_PORT = parseInt(process.env.NITRADO_SERVER_RCON_PORT ?? '25315', 10)
